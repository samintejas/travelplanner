...
ACTIVITIES_BY_CITY = {
    ...
    "Tokyo": [
        ...
        {"name": "Tsukiji Outer Market Tour", "category": "Food", "base_price": 50, "duration": 3},
        ...
        {"name": "Shibuya & Harajuku Walking Tour", "category": "Tour", "base_price": 45, "duration": 4},
        {"name": "Tokyo Skytree Observation", "category": "Landmark", "base_price": 25, "duration": 2},
        {"name": "Akihabara Tech & Anime Tour", "category": "Tour", "base_price": 40, "duration": 3},
    ],
    "Kyoto": [
        {"name": "Fushimi Inari Shrine Visit", "category": "Landmark", "base_price": 0, "duration": 3},
        {"name": "Kinkaku-ji Golden Pavilion", "category": "Landmark", "base_price": 5, "duration": 2},
        {"name": "Arashiyama Bamboo Grove", "category": "Nature", "base_price": 0, "duration": 3},
        {"name": "Gion Geisha District Walk", "category": "Tour", "base_price": 35, "duration": 2},
        {"name": "Traditional Tea Ceremony", "category": "Experience", "base_price": 50, "duration": 1.5},
        {"name": "Nijo Castle Tour", "category": "Landmark", "base_price": 15, "duration": 2},
        {"name": "Kaiseki Dining Experience", "category": "Food", "base_price": 150, "duration": 2},
        {"name": "Nara Day Trip (Deer Park & Temples)", "category": "Day Trip", "base_price": 60, "duration": 6},
    ],
    "Osaka": [
        {"name": "Dotonbori Street Food Tour", "category": "Food", "base_price": 65, "duration": 3},
        {"name": "Osaka Castle Tour", "category": "Landmark", "base_price": 10, "duration": 2},
        {"name": "Kuromon Market Visit", "category": "Food", "base_price": 0, "duration": 2},
        {"name": "Universal Studios Japan", "category": "Entertainment", "base_price": 80, "duration": 8},
        {"name": "Takoyaki & Okonomiyaki Class", "category": "Experience", "base_price": 70, "duration": 2},
        {"name": "Shinsekai District Tour", "category": "Tour", "base_price": 30, "duration": 2},
        {"name": "Himeji Castle Day Trip", "category": "Day Trip", "base_price": 75, "duration": 5},
    ],
    "Rome": [
